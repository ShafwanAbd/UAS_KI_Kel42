                        ...
                        <div class="mb-3 text-start">
                            <div class="d-row d-flex justify-content-center">
                                <div class="form-check pt-1">
                                    <input class="form-check-input shadow" type="checkbox" name="remember" id="remember" value="{{ old('remember') ? 'checked' : '' }}">
                                ...
                                <a class="btn btn-link fst-italic ms-auto" href="{{ route('password.request') }}" style="font-size: small;">
